...
/*
-----------------------------------------------------
    SAMP naudas spraudņa konfigurācija
-----------------------------------------------------
*/
...
*/
$c[$p]['db']['table'] = "baltsms_samp_money";
...
$c['lang'][$p]['lv'] = array(
    "instructions" => "Lai iegādātos <LENGTH> naudiņas par <PRICE> EUR, sūti kodu <b><KEYWORD><CODE></b> uz <b><NUMBER></b>, lai saņemtu atslēgas kodu!<br>Ar PayPal var maksat UCP paneli<br><span style='color:red'>Tu nedrīksti atrasties spēlē pasūtot pakalpojumu!</span>",
	# Kļūdas
...
$c['lang'][$p]['en'] = array(
	"instructions" => "To purchase <LENGTH> money for <PRICE> EUR, send the following code: <b><KEYWORD><CODE></b> to <b><NUMBER></b> to receive an unclock code!",
	# Kļūdas
