...
$c['lang'][$p]['lv'] = array(
    "instructions" => "Lai iegādātos unban par <PRICE> EUR, sūti kodu <b><KEYWORD><CODE></b> uz <b><NUMBER></b>, lai saņemtu atslēgas kodu!",
	# Kļūdas
    ...
    "unban_purchased" => "Bans noņemts. Lai jauka spēlēšana!",
	# Forma
    "form_price" => "Cena",
...
$c['lang'][$p]['en'] = array(
	...
	"unban_purchased" => "The money was purchased successfully. Have fun!",
	# Forma
	"form_price" => "Price",
...
if(isset($_POST['code'])):
	...
	if(count($errors) > 0){
		...
		if($baltsms->getResponse() === true){
			...
			$paymentStatus = 1;
			echo baltsms::alert($lang[$p]['unban_purchased'], "success");
			?>
