...
class baltsms{
	...
	public static function createTable($plugin, $table){
		...
		if($plugin == "donate"){
			...
			$db->insert("CREATE TABLE `$table` (`id` int(11) NOT NULL AUTO_INCREMENT, `nickname` varchar(55) NOT NULL ,`server` varchar(25) NOT NULL, `access` varchar(32) NOT NULL, `time` varchar(10) NOT NULL, `expires` int(16) NOT NULL ,PRIMARY KEY (`id`)) ENGINE=MyISAM DEFAULT CHARSET=latin1 AUTO_INCREMENT=1;");
		}
	}
